namespace FormQLKH
{
    partial class UC_QLDonNhap
    {
        ...
        private void InitializeComponent()
        {
            ...
            tlpQLDN.RowStyles.Add(new RowStyle(SizeType.Absolute, 422F));
            tlpQLDN.RowStyles.Add(new RowStyle(SizeType.Absolute, 244F));
            ...
            // grbQLDN_TT
            // 
            grbQLDN_TT.BackgroundImage = Properties.Resources.bg3;
            ...
            grbQLDN_TT.Location = new Point(3, 503);
            grbQLDN_TT.Name = "grbQLDN_TT";
            grbQLDN_TT.Size = new Size(1414, 238);
            ...
            grbQLDN_HT.Size = new Size(1414, 416);
