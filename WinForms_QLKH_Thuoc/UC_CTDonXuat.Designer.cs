namespace FormQLKH
{
    partial class UC_CTDonXuat
    {
        ...
        private void InitializeComponent()
        {
            ...
            lbCTDX_MaDX = new Label();
            tlpCTDX.SuspendLayout();
            pnCTDX.SuspendLayout();
            grbCTDX_TT.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)numCTDX_SoLuong).BeginInit();
            SuspendLayout();
            // 
            // tlpCTDX
            // 
            tlpCTDX.ColumnCount = 1;
            tlpCTDX.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
            tlpCTDX.Controls.Add(pnCTDX, 0, 0);
            tlpCTDX.Controls.Add(grbCTDX_TT, 0, 1);
            tlpCTDX.Dock = DockStyle.Fill;
            tlpCTDX.Location = new Point(0, 0);
            tlpCTDX.Name = "tlpCTDX";
            tlpCTDX.RowCount = 2;
            ...
            // pnCTDX
            // 
            pnCTDX.BackColor = Color.FromArgb(63, 139, 208);
            pnCTDX.Controls.Add(lbCTDX);
            ...
            // lbCTDX
            // 
            lbCTDX.AutoSize = true;
            lbCTDX.Font = new Font("Segoe UI", 13.875F, FontStyle.Bold, GraphicsUnit.Point);
            lbCTDX.ForeColor = Color.White;
            lbCTDX.Location = new Point(149, 15);
            lbCTDX.Name = "lbCTDX";
            lbCTDX.Size = new Size(375, 50);
            lbCTDX.TabIndex = 0;
            lbCTDX.Text = "CHI TIẾT ĐƠN XUẤT";
            // 
            // grbCTDX_TT
            // 
            ...
            grbCTDX_TT.ResumeLayout(false);
            grbCTDX_TT.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)numCTDX_SoLuong).EndInit();
            ResumeLayout(false);
        }

        #endregion

        private TableLayoutPanel tlpCTDX;
        private Panel pnCTDX;
        private Label lbCTDX;
        private GroupBox grbCTDX_TT;
        private NumericUpDown numCTDX_SoLuong;
